...
class DatabaseSeeder extends Seeder
{
    ...
    {
        foreach ([
            ['Contract Signed', 'Contract', 1, null, false],
            ['Deposit Received', 'Contract', 1, null, false],
            ['Design Approved', 'Contract', 1, null, false],
            ['Permit Submitted', 'Contract', 1, null, false],
            ['Permit Received', 'Contract', 1, null, false],
            ['Layout', 'Excavation', 1, 'pool-construction', false],
            ['Excavation', 'Excavation', 2, 'excavation', false],
            ['Haul Off', 'Excavation', 1, 'pool-construction', false],
            ['Steel Installation', 'Structure', 3, 'pool-construction', false],
            ['Plumbing Rough-In', 'Structure', 3, 'plumbing', false],
            ['Electrical Rough-In', 'Structure', 2, 'electrical', false],
            ['Bonding', 'Structure', 1, 'electrical', false],
            ['Pre-Gun Inspection', 'Structure', 1, null, false],
            ['Shotcrete', 'Shell', 1, 'pool-construction', false],
            ['Cure Period', 'Shell', 7, null, true],
            ['Tile', 'Finish Structure', 5, 'tile-stone', false],
            ['Coping', 'Finish Structure', 3, 'decking', false],
            ['Equipment Set', 'Finish Structure', 2, 'automation', false],
            ['Deck Preparation', 'Decking', 2, 'decking', false],
            ['Deck Pour', 'Decking', 1, 'decking', false],
            ['Deck Finish', 'Decking', 2, 'decking', false],
            ['Interior Finish', 'Interior', 3, 'pool-construction', false],
            ['Pool Fill', 'Interior', 1, 'pool-construction', false],
            ['Startup', 'Interior', 2, 'pool-construction', false],
            ['Final Inspection', 'Completion', 1, null, false],
            ['Punch List', 'Completion', 2, 'pool-construction', false],
            ['Customer Walkthrough', 'Completion', 1, null, false],
            ['Final Payment', 'Completion', 1, null, false],
            ['Project Complete', 'Completion', 1, null, false],
        ] as $index => [$name, $phase, $duration, $typeSlug, $usesCalendarDays]) {
